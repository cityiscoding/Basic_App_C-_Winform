...
namespace CaculatorTest
{
    public class PhanSoTest
    {
        ...
        public class PhanSoTests
        {
           ...
           [TestMethod]
            public void TestChiaPhanSoWithZeroDenominator()
            {
                //Arrange
                 PhanSo ps1 = new PhanSo(1, 2);
                PhanSo ps2 = new PhanSo(2, 0); 

                //Act & Assert
                PhanSo result = ps1.Chia(ps2);

                //Đối chiếu kết quả với giá trị mong đợi
                Assert.IsFalse(result.ToString() == "", "Phép chia không hợp lệ!");
            }
